...
export function activate(context: vscode.ExtensionContext) 
                                    { 
                                      const command = 'magmanotebook.sayHello';
                                      ...
                                      const newMagmaNotebook = async () => {
                                        ...
                                        const notebook = await vscode.workspace.openNotebookDocument('magma-notebook', jsonNotebook);                                        
                                        vscode.commands.executeCommand('vscode.open', notebook.uri);
                                      };
                                      context.subscriptions.push(vscode.commands.registerCommand('magma-notebook.newNotebook', newMagmaNotebook));
                                    }
...
class MagmaController {
  ...
  //   let notebookid=_notebook.uri.toString(true); 
  //   this.magmaActiveRuns[notebookid].socket.
